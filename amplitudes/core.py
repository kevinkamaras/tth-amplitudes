...
def tthggg(t1, tbar2, h3, g4, g5, g6, hcase):
    ...
    p245 = [tbar2, g4, g5]
    hat5, hat6 = hp.onShell(g5, g6, p245, hcase)
    hatp136 = t1 + h3 + hat6
    d2 = tthg(t1, hatp136, h3, hat6, hcase[2]) * hp.ttgg(-hatp136, tbar2, g4, hat5, hcase[:2]) / (np.vdot(p245, p245) - hp.mtop**2)
...
def tthqqg(t1, tbar2, h3, q4, qbar5, g6, hcase):
    ...
    p245 = [tbar2, q4, qbar5]
    hat5, hat6 = hp.onShell(qbar5, g6, p245, hcase)
    hatp136 = t1 + h3 + hat6
    d2 = tthg(t1, hatp136, h3, hat6, hcase[2]) * hp.ttqq(-hatp136, tbar2, q4, hat5, hcase[:2]) / (np.vdot(p245, p245) - hp.mtop**2)
...
def tthgggg(t1, tbar2, h3, g4, g5, g6, g7, hcase):
    ...
    p2456 = [tbar2, g4, g5, g6]
    hat6, hat7 = hp.onShell(g6 ,g7, p2456, hcase)
    hatp137 = t1 + h3 + hat7
    d2 = tthg(t1, hatp137, h3, g7, hcase[3]) * hp.ttggg(-hatp137, tbar2, g4, g5, hat6, hcase[:3]) / (np.vdot(p2456, p2456) - hp.mtop**2)
